		...
		<section class="page-title">
			<div class="card"><br/><br/>
				<div class="card-img-overlay">
					<div class="container">
						<h1 class="card-title">Account Confirmation (Teacher)</h1>
					</div>
				</div>
			</div>
		</section>
		<section class="bg-f5 m-b-0 p-t-1000">
			<div class="container">
				<div class="card card-box max-w-1000">
					...
					<form class="card-body" action="teacher-registration-activate.php" method="post">
						<div class="form-group">
							<label>Email:</label>
							<input name="teach_email" type="text" class="form-control" placeholder="Type Email Here">
							<label>Confirmation Code:</label>
							<input name="teach_conf_code" type="text" class="form-control" placeholder="Type Confirmation Code Here">
						</div>
						<input type="submit" name="teach_act_submit" Value="Activate your account" class="btn m-t-15">
				</div>
			</div>
		</section>
		<footer>
