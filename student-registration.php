...
////////////////////////////////////////////////////////////////////////////////////////////////////////////    
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////         
          ...
          ////////////////////////////////////////////////////////////////////////////////////
                ...
                $phone_no = mysqli_query($conn, "SELECT * FROM student_registration WHERE phone='$phone_no'");
                
                $check_email = mysqli_query($conn, "SELECT * FROM student_registration WHERE email='$email'");
...
<head>
		...
		<title>::.Meet-Up Career - Student Registration Form.::</title>
		...
		<section class="page-title">
			<div class="card"><br/><br/>
				<div class="card-img-overlay">
					<div class="container">
						<h1 class="card-title">Register as a Student</h1>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="card card-box max-w-1000">
					<div class="card-header">
						<h3 class="">Register as a Student</h3>
					</div>
    ...
    <div class="row">
        <div class="col-md-10 mx-auto">
            ...
            <form action="server.php" method="post">
				...
				<div class="form-group row">
                    <div class="col-sm-6">
                        <label for="inputAddressLine2">Country of Residence</label>
                ...
                <div class="col-sm-6">
                        <label for="inputCity">Fluent Language</label>
                        <select name="flanguage" class="form-control" required>
                            <option value="">----</option>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                            ...
                            <input type="text" name="address" class="form-control" id="inputAddressLine1" placeholder="Address" required>
                        </div>

                        <div class="col-sm-6">
                            <label for="inputAddressLine1">Date of Birth</label>
                            <input type="date" name="dob" class="form-control" id="inputAddressLine1" placeholder="Date of Birth" required>
                        </div>
                    ...
                    <div class="form-group row">
                        <div class="col-sm-6">
                        <label for="inputFirstname">ID type</label>
                        
                        <select name="id_type" class="form-control" required>
                        <option value="">----</option>
                        <option value="Mr">School ID</option>
                        <option value="Mrs">National ID</option>
                        <option value="Miss">International Passport</option>
                        <option value="Dr.">Voter's Card</option>
                        
                        </select>
                    </div>

                    <div class="col-sm-6">
                        <label for="inputAddressLine2">Nationality</label>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <label for="inputAddressLine2">Field of Interest</label>
                ...
                <input type="submit" value="submit" name="stud_submit" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#myModal">
            </form>
        </div>
    </div>
</div>
