...
<head>
		...
		<title>::.MeetUp-Career - Registration Success.::</title>
				...
				<div class="row">
					<div class="col-md-4">
						<div class="card">
							...
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">I am a Student</a>
								</h4>
								<p>Click the register button below to register as a student</p>
								<a href="post-graduate-registration.php" class="btn bg-4f84c4">Register</a>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="card bg-4f84c4">
							...
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">I am a Professional</a>
								</h4>
								<p>Click the register button below to register as a professional</p>
								<a href="professional-registration.php" class="btn bg-f">Register</a>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="card">
							...
							<div class="card-body">
								<h4 class="card-title">
									<a href="#">I am a Teacher</a>
								</h4>
								<p>Click the register button below to register as a teacher</p>
								<a href="teacher-registration.php" class="btn bg-4f84c4">Register</a>
							</div>
						</div>
					</div>
				</div>
