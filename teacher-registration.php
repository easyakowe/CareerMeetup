...
////////////////////////////////////////////////////////////////////////////////////////////////////////////    
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////         
          ...
          ////////////////////////////////////////////////////////////////////////////////////
                ...
                $phone_no = mysqli_query($conn, "SELECT * FROM teacher_registration WHERE phone_no='$phone_no'");
                
                $check_email = mysqli_query($conn, "SELECT * FROM teacher_registration WHERE email='$email'");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////             
                mysqli_query($conn, "INSERT INTO teacher_registration VALUES( '', '$random_chars', '$title', '$first_name', '$last_name', '$gender', '$country', '$city', '$language', '$educational_level', '$field_of_study', '$phone_no', '$email', '$password', '$date2', '0')");
...
<head>
		...
		<title>::.Meet-Up Career - Teacher Registration Form.::</title>
		...
		<section class="page-title">
			<div class="card"><br/><br/>
				<div class="card-img-overlay">
					<div class="container">
						<h1 class="card-title">Register as a Teacher</h1>
					</div>
				</div>
			</div>
		</section>
			...
			<div class="container">
				<div class="card card-box max-w-1000">
					<div class="card-header">
						<h3 class="">Register as a Teacher</h3>
					</div>
...
<select id="country" name="country" class="form-control" required>
                ...
                <input type="submit" value="submit" name="teach_submit" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#myModal">
            </form>
        </div>
    </div>
</div>
